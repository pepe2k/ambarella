...
{"probesize", "set probing size", OFFSET(probesize), FF_OPT_TYPE_INT, 6400, 32, INT_MAX, D},
#elif CONFIG_PRJA
{"probesize", "set probing size", OFFSET(probesize), FF_OPT_TYPE_INT, 256*1024, 32, INT_MAX, D},
#else
...
#if TARGET_USE_AMBARELLA_A5S_DSP
{"analyzeduration", "how many microseconds are analyzed to estimate duration", OFFSET(max_analyze_duration), FF_OPT_TYPE_INT, AV_TIME_BASE, 0, INT_MAX, D},
#else
