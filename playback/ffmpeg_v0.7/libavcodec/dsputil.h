...
//from mpeg2 reference code, microsoft?
//use reference DCT
//#define __use_reference_dct__

//use cm DCT
#define __use_cm_dct__
...
void ff_put_vc1_pixels8x8_ ## depth ## _c(uint8_t *dst, const uint8_t *src, int stride, int h);\
void ff_avg_vc1_pixels8x8_ ## depth ## _c(uint8_t *dst, const uint8_t *src, int stride, int h);\
void ff_put_vc1_pixels16x16_ ## depth ## _c(uint8_t *dst, const uint8_t *src, int stride, int h);\
void ff_avg_vc1_pixels16x16_ ## depth ## _c(uint8_t *dst, const uint8_t *src, int stride, int h);
...
#define ff_put_vc1_pixels8x8_c ff_put_vc1_pixels8x8_8_c
#define ff_avg_vc1_pixels8x8_c ff_avg_vc1_pixels8x8_8_c
#define ff_put_vc1_pixels16x16_c ff_put_vc1_pixels16x16_8_c
#define ff_avg_vc1_pixels16x16_c ff_avg_vc1_pixels16x16_8_c
...
void ff_emulated_edge_mc_nv12_ ## depth (uint8_t *buf, const uint8_t *src, int linesize,\
                         int block_w, int block_h,\
                         int src_x, int src_y, int w, int h);
...
#define ff_emulated_edge_mc_nv12 ff_emulated_edge_mc_nv12_8

void ff_add_pixels_clamped_c(const DCTELEM *block, uint8_t *dest, int linesize);
void ff_put_pixels_clamped_c(const DCTELEM *block, uint8_t *dest, int linesize);
void ff_put_signed_pixels_clamped_c(const DCTELEM *block, uint8_t *dest, int linesize);

void ff_add_pixels_clamped_nv12_c(const DCTELEM *block, uint8_t *dest, int linesize);
void ff_put_pixels_clamped_nv12_c(const DCTELEM *block, uint8_t *dest, int linesize);
...
typedef struct DSPContext {
    ...
    void (*put_pixels_clamped_chroma_nv12)(const DCTELEM *block/*align 16*/, uint8_t *pixels/*align 8*/, int line_size);
    ...
    void (*add_pixels_clamped_chroma_nv12)(const DCTELEM *block/*align 16*/, uint8_t *pixels/*align 8*/, int line_size);
    ...
    void (*emulated_edge_mc)(uint8_t *buf, const uint8_t *src, int linesize,
                             int block_w, int block_h,
                             int src_x, int src_y, int w, int h);
    void (*emulated_edge_mc_nv12)(uint8_t *buf, const uint8_t *src, int linesize,
                             int block_w, int block_h,
                             int src_x, int src_y, int w, int h);
    /**
    ...
    void (*gmc1_nv12)(uint8_t *dst/*align 8*/, uint8_t *src/*align 1*/, int srcStride, int h, int x16, int y16, int rounder);
    /**
     * global motion compensation.
     */
    void (*gmc )(uint8_t *dst/*align 8*/, uint8_t *src/*align 1*/, int stride, int h, int ox, int oy,
                    int dxx, int dxy, int dyx, int dyy, int shift, int r, int width, int height);
    void (*gmc_nv12 )(uint8_t *dst/*align 8*/, uint8_t *src/*align 1*/, int stride, int h, int ox, int oy,
                    int dxx, int dxy, int dyx, int dyy, int shift, int r, int width, int height);
...
// 16x16 8x8 4x4 2x2 16x8 8x4 4x2 8x16 4x8 2x4
    ...
    //nv12 related
    op_pixels_func put_pixels_tab_nv12[4][4];
    op_pixels_func avg_pixels_tab_nv12[4][4];
    op_pixels_func put_no_rnd_pixels_tab_nv12[4][4];
    op_pixels_func avg_no_rnd_pixels_tab_nv12[4][4];
    ...
    //nv12
    h264_chroma_mc_func put_h264_chroma_pixels_tab_nv12[3];
    h264_chroma_mc_func avg_h264_chroma_pixels_tab_nv12[3];
    //amba
    h264_chroma_mc_func put_h264_chroma_pixels_tab_amba[3];
    h264_chroma_mc_func avg_h264_chroma_pixels_tab_amba[3];
    ...
    void (*h263_h_loop_filter_nv12)(uint8_t *src, int stride, int qscale);
    ...
    void (*idct_original)(DCTELEM *block/* align 16*/);
    ...
    void (*idct_put_original)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);
    ...
    void (*idct_add_original)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);

    void (*idct_put_nv12)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);
    void (*idct_put_nv12_original)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);

    void (*idct_add_nv12)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);
    void (*idct_add_nv12_original)(uint8_t *dest/*align 8*/, int line_size, DCTELEM *block/*align 16*/);
    /**
    ...
    uint8_t* p_idct_permutation;
    uint8_t amba_idct_permutation[64];//transposed matrix before idct
    int amba_idct_permutation_type;
    #endif
...
#define RECON_SHIFT 6
    ...
    void (*draw_edges_nv12)(uint8_t *buf, int wrap, int width, int height);
...
#define EDGE_BOTTOM 2
    ...
    //nv12
    h264_chroma_mc_func put_rv40_chroma_pixels_tab_nv12[3];
    h264_chroma_mc_func avg_rv40_chroma_pixels_tab_nv12[3];
    /* bink functions */
