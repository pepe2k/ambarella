...
//nv12 related
void ff_put_pixels8_arm_nv12(uint8_t *block, const uint8_t *pixels, int line_size, int h);
void ff_put_pixels8_y2_arm_nv12(uint8_t *block, const uint8_t *pixels, int line_size, int h);
void ff_put_no_rnd_pixels8_y2_arm_nv12(uint8_t *block, const uint8_t *pixels, int line_size, int h);
...
void dsputil_init_arm(DSPContext* c, AVCodecContext *avctx)
{
    ...
    c->put_pixels_tab_nv12[0][0] = ff_put_pixels16_arm;
    c->put_pixels_tab_nv12[0][1] = ff_put_pixels16_x2_arm;
    c->put_pixels_tab_nv12[0][2] = ff_put_pixels16_y2_arm;
    c->put_pixels_tab_nv12[0][3] = ff_put_pixels16_xy2_arm;
    c->put_no_rnd_pixels_tab_nv12[0][0] = ff_put_pixels16_arm;
    c->put_no_rnd_pixels_tab_nv12[0][1] = ff_put_no_rnd_pixels16_x2_arm;
    c->put_no_rnd_pixels_tab_nv12[0][2] = ff_put_no_rnd_pixels16_y2_arm;
    c->put_no_rnd_pixels_tab_nv12[0][3] = ff_put_no_rnd_pixels16_xy2_arm;
    
    c->put_pixels_tab_nv12[1][0] = ff_put_pixels8_arm_nv12;
//    c->put_pixels_tab_nv12[1][1] = put_pixels8_x2_arm_nv12;
    c->put_pixels_tab_nv12[1][2] = ff_put_pixels8_y2_arm_nv12;
//    c->put_pixels_tab_nv12[1][3] = put_pixels8_xy2_arm_nv12;
    c->put_no_rnd_pixels_tab_nv12[1][0] = ff_put_pixels8_arm_nv12;
//    c->put_no_rnd_pixels_tab_nv12[1][1] = put_no_rnd_pixels8_x2_arm_nv12;
    c->put_no_rnd_pixels_tab_nv12[1][2] = ff_put_no_rnd_pixels8_y2_arm_nv12;
//    c->put_no_rnd_pixels_tab_nv12[1][3] = put_no_rnd_pixels8_xy2_arm_nv12;
    }
...
void ff_put_pixels8_arm_nv12(uint8_t *block, const uint8_t *pixels, int line_size, int h)
{
    ff_put_pixels8_arm(block,pixels,line_size,h);
    ff_put_pixels8_arm(block+8,pixels+8,line_size,h);    
}

void ff_put_pixels8_y2_arm_nv12(uint8_t *block, const uint8_t *pixels, int line_size, int h)
{
    ff_put_pixels8_y2_arm(block,pixels,line_size,h);
    ff_put_pixels8_y2_arm(block+8,pixels+8,line_size,h);    
}

void ff_put_no_rnd_pixels8_y2_arm_nv12(uint8_t *block, const uint8_t *pixels, int line_size, int h)
{
    ff_put_no_rnd_pixels8_y2_arm(block,pixels,line_size,h);
    ff_put_no_rnd_pixels8_y2_arm(block+8,pixels+8,line_size,h);    
}