...
//nv12 related
static void ff_put_pixels8_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h);
static void ff_put_pixels8_x2_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h);
static void ff_put_pixels8_y2_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h);
static void ff_put_pixels8_xy2_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h);
static void ff_put_pixels8_x2_no_rnd_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h);
static void ff_put_pixels8_y2_no_rnd_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h);
static void ff_put_pixels8_xy2_no_rnd_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h);
...
void ff_dsputil_init_neon(DSPContext *c, AVCodecContext *avctx)
{
    ...
    c->put_pixels_tab_nv12[0][0] = ff_put_pixels16_neon;
    c->put_pixels_tab_nv12[0][1] = ff_put_pixels16_x2_neon;
    c->put_pixels_tab_nv12[0][2] = ff_put_pixels16_y2_neon;
    c->put_pixels_tab_nv12[0][3] = ff_put_pixels16_xy2_neon;
    c->put_pixels_tab_nv12[1][0] = ff_put_pixels8_neon_nv12;
    c->put_pixels_tab_nv12[1][1] = ff_put_pixels8_x2_neon_nv12;
    c->put_pixels_tab_nv12[1][2] = ff_put_pixels8_y2_neon_nv12;
    c->put_pixels_tab_nv12[1][3] = ff_put_pixels8_xy2_neon_nv12;

    c->put_no_rnd_pixels_tab_nv12[0][0] = ff_put_pixels16_neon;
    c->put_no_rnd_pixels_tab_nv12[0][1] = ff_put_pixels16_x2_no_rnd_neon;
    c->put_no_rnd_pixels_tab_nv12[0][2] = ff_put_pixels16_y2_no_rnd_neon;
    c->put_no_rnd_pixels_tab_nv12[0][3] = ff_put_pixels16_xy2_no_rnd_neon;
    c->put_no_rnd_pixels_tab_nv12[1][0] = ff_put_pixels8_neon_nv12;
    c->put_no_rnd_pixels_tab_nv12[1][1] = ff_put_pixels8_x2_no_rnd_neon_nv12;
    c->put_no_rnd_pixels_tab_nv12[1][2] = ff_put_pixels8_y2_no_rnd_neon_nv12;
    c->put_no_rnd_pixels_tab_nv12[1][3] = ff_put_pixels8_xy2_no_rnd_neon_nv12;
    }
...
static void ff_put_pixels8_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h)
{
    ff_put_pixels8_neon(d,s,stride,h);
    ff_put_pixels8_neon(d+8,s+8,stride,h);
}

static void ff_put_pixels8_x2_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h)
{
    ff_put_pixels8_x2_neon(d,s,stride,h);
    ff_put_pixels8_x2_neon(d+8,s+8,stride,h);
}

static void ff_put_pixels8_y2_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h)
{
    ff_put_pixels8_y2_neon(d,s,stride,h);
    ff_put_pixels8_y2_neon(d+8,s+8,stride,h);
}

static void ff_put_pixels8_xy2_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h)
{
    ff_put_pixels8_xy2_neon(d,s,stride,h);
    ff_put_pixels8_xy2_neon(d+8,s+8,stride,h);
}

static void ff_put_pixels8_x2_no_rnd_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h)
{
    ff_put_pixels8_x2_no_rnd_neon(d,s,stride,h);
    ff_put_pixels8_x2_no_rnd_neon(d+8,s+8,stride,h);
}

static void ff_put_pixels8_y2_no_rnd_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h)
{
    ff_put_pixels8_y2_no_rnd_neon(d,s,stride,h);
    ff_put_pixels8_y2_no_rnd_neon(d+8,s+8,stride,h);
}

static void ff_put_pixels8_xy2_no_rnd_neon_nv12(uint8_t * d, const uint8_t * s, int stride, int h)
{
    ff_put_pixels8_xy2_no_rnd_neon(d,s,stride,h);
    ff_put_pixels8_xy2_no_rnd_neon(d+8,s+8,stride,h);
}
