...
const uint8_t rv40_aic_top_vlc_codes[AIC_TOP_SIZE] = {
 0x01, 0x05, 0x01, 0x00, 0x03, 0x3D, 0x1D, 0x02,
 0x04, 0x3C, 0x3F, 0x1C, 0x0D, 0x3E, 0x0C, 0x01
};

const uint8_t rv40_aic_top_vlc_bits[AIC_TOP_SIZE] = {
...
const uint16_t aic_mode2_vlc_codes[AIC_MODE2_NUM][AIC_MODE2_SIZE] = {
...
const uint8_t aic_mode1_vlc_codes[AIC_MODE1_NUM][AIC_MODE1_SIZE] = {
...
const uint8_t aic_mode1_vlc_bits[AIC_MODE1_NUM][AIC_MODE1_SIZE] = {
 {  1,  4,  2,  7,  4,  6,  4,  7,  5,},
 {  5,  1,  3,  4,  6,  3,  3,  7,  7,},
 {  1,  4,  2,  7,  6,  7,  5,  4,  4,},
 {  1,  3,  3,  3,  7,  4,  5,  7,  6,},
...
const uint8_t ptype_vlc_codes[NUM_PTYPE_VLCS][PTYPE_VLC_SIZE] = {
...
const uint8_t ptype_vlc_bits[NUM_PTYPE_VLCS][PTYPE_VLC_SIZE] = {
 { 1, 2, 3, 6, 5, 4, 7, 7 },
 { 3, 1, 2, 7, 6, 5, 4, 7 },
 { 5, 4, 1, 4, 3, 3, 4, 5 },
 { 4, 5, 2, 2, 3, 2, 6, 6 },
...
const uint8_t ptype_vlc_syms[PTYPE_VLC_SIZE] = {
...
const uint8_t btype_vlc_codes[NUM_BTYPE_VLCS][BTYPE_VLC_SIZE] = {
...
const uint8_t btype_vlc_bits[NUM_BTYPE_VLCS][PTYPE_VLC_SIZE] = {
 { 2, 3, 2, 2, 5, 4, 5 },
 { 4, 1, 3, 2, 6, 5, 6 },
 { 6, 4, 1, 2, 5, 3, 6 },
 { 5, 3, 3, 1, 4, 3, 5 },
...
const uint8_t btype_vlc_syms[BTYPE_VLC_SIZE] = {
...
VLC aic_top_vlc;
VLC aic_mode1_vlc[AIC_MODE1_NUM], aic_mode2_vlc[AIC_MODE2_NUM];
VLC ptype_vlc[NUM_PTYPE_VLCS], btype_vlc[NUM_BTYPE_VLCS];

const int16_t mode2_offs[] = {
