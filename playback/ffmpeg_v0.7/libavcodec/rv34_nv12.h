 ...
 */
int ff_rv34_nv12_get_start_offset(GetBitContext *gb, int blocks);
int ff_rv34_nv12_decode_init(AVCodecContext *avctx);
int ff_rv34_nv12_decode_frame(AVCodecContext *avctx, void *data, int *data_size, AVPacket *avpkt);
int ff_rv34_nv12_decode_end(AVCodecContext *avctx);
