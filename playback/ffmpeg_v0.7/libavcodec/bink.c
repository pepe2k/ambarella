    ...
    for (by = 0; by < bh; by++) {
        ...
        for (bx = 0; bx < bw; bx++, dst += 8) {
            ...
            case 2:
                ...
                read_dct_coeffs(gb, block, c->scantable.permutated, (const uint32_t (*)[64])binkb_intra_quant, qp);
            ...
            case 4:
                ...
                read_dct_coeffs(gb, block, c->scantable.permutated, (const uint32_t (*)[64])binkb_inter_quant, qp);
