...
private:
  ServerMediaSession *lookupServerMediaSessionAmba(char const *streamName);
  ServerMediaSession *lookupServerMediaSessionAmba2(char const *streamName);
  ServerMediaSession *lookupServerMediaSessionAmba3(char const *streamName);
};
