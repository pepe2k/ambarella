...
static PVRSRV_ERROR SysLocateDevices(SYS_DATA *psSysData)
{
	...
	gsSGXDeviceMap.ui32RegsSize = SYS_IONE4430_SGX_REGS_SIZE;
...
#else	
	gsSGXDeviceMap.sRegsSysPBase.uiAddr = SYS_IONE4430_SGX_REGS_SYS_PHYS_BASE;
	gsSGXDeviceMap.sRegsCpuPBase = SysSysPAddrToCpuPAddr(gsSGXDeviceMap.sRegsSysPBase);
	gsSGXDeviceMap.ui32RegsSize = SYS_IONE4430_SGX_REGS_SIZE;

	gsSGXDeviceMap.ui32IRQ = SYS_IONE4430_SGX_IRQ;
...
#if !defined(PVR_NO_IONE_TIMER)
#if defined(PVR_IONE_TIMER_BASE_IN_SYS_SPEC_DATA)
	TimerRegPhysBase = gsSysSpecificData.sTimerRegPhysBase;
#else
	TimerRegPhysBase.uiAddr = SYS_IONE4430_GP11TIMER_REGS_SYS_PHYS_BASE;
#endif
...
PVRSRV_ERROR SysDeinitialise (SYS_DATA *psSysData)
{
	...
	if(gsSGXRegsCPUVAddr != IMG_NULL)
	{
		...
		OSBaseFreeContigMemory(SYS_IONE4430_SGX_REGS_SIZE, gsSGXRegsCPUVAddr, gsSGXDeviceMap.sRegsCpuPBase);
#else
#if defined(SGX_OCP_REGS_ENABLED)
