...
#include <linux/platform_device.h>
    ...
    !defined(PVR_NO_IONE_TIMER)
#define	PVR_IONE4_TIMING_PRCM
#endif

#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,35))
//#include <plat/gpu.h>
#if !defined(PVR_NO_IONE_TIMER)
#define	PVR_IONE_USE_DM_TIMER_API
//#include <plat/dmtimer.h>
#endif
#endif

#if !defined(PVR_NO_IONE_TIMER)
#define PVR_IONE_TIMER_BASE_IN_SYS_SPEC_DATA
#endif
#endif
...
typedef struct _SYS_SPECIFIC_DATA_TAG_
{
	...
	struct ione_dm_timer *psGPTimer;
#endif
...
#endif
static SGX_INLINE PVRSRV_ERROR SysPMRuntimeRegister(void)
{
	return PVRSRV_OK;
}
...
#endif
static SGX_INLINE PVRSRV_ERROR SysPMRuntimeUnregister(void)
{
	return PVRSRV_OK;
}
...
#endif
static SGX_INLINE PVRSRV_ERROR SysDvfsInitialize(void)
{
	return PVRSRV_OK;
}
...
#endif
static SGX_INLINE PVRSRV_ERROR SysDvfsDeinitialize(void)
{
	return PVRSRV_OK;
}
