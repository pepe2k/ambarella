...
#if defined(SUPPORT_IONE_SGXFCLK_96M)
...
#define SGX_PARENT_CLOCK "core_ck"
	...
	defined(SYS_IONE_PIN_MEMORY_BUS_CLOCK)
#include <linux/platform_device.h>
extern struct platform_device *gpsPVRLDMDev;
#if defined(SGX530) && (SGX_CORE_REV == 125)
#define IONE_MEMORY_BUS_CLOCK_MAX 800000
#else
#define IONE_MEMORY_BUS_CLOCK_MAX 664000
#endif
#else
#undef SYS_IONE_PIN_MEMORY_BUS_CLOCK
#endif
...
struct clk *clk_get_parent(struct clk *pp)
{
	return NULL;
}
...
#if defined(SYS_IONE_PIN_MEMORY_BUS_CLOCK)
	ione_pm_set_min_bus_tput(&gpsPVRLDMDev->dev, OCP_INITIATOR_AGENT, IONE_MEMORY_BUS_CLOCK_MAX);
#endif
...
#if defined(SYS_IONE_PIN_MEMORY_BUS_CLOCK)
	ione_pm_set_min_bus_tput(&gpsPVRLDMDev->dev, OCP_INITIATOR_AGENT, 0);
#endif
...
PVRSRV_ERROR EnableSystemClocks(SYS_DATA *psSysData)
{
	...
	TimerRegPhysBase.uiAddr = SYS_IONE_GP11TIMER_TSICR_SYS_PHYS_BASE;
	...
	TimerRegPhysBase.uiAddr = SYS_IONE_GP11TIMER_ENABLE_SYS_PHYS_BASE;
	pui32TimerEnable = OSMapPhysToLin(TimerRegPhysBase,
                  4,
                  PVRSRV_HAP_KERNEL_ONLY|PVRSRV_HAP_UNCACHED,
                  &hTimerEnable);
