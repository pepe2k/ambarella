...
void __ambcache_clean_range(const void *pvStart, const void *pvEnd);
void __ambcache_inv_range(const void *pvStart, const void *pvEnd);
...
void __ambcache_clean_range(const void *pvStart, const void *pvEnd)
{
	...
	addr_start = (u32)pvStart & CACHE_LINE_MASK;
	addr_end = ((u32)pvEnd + CACHE_LINE_SIZE - 1) & CACHE_LINE_MASK;
...
{
	return CheckExecuteCacheOp(hOSMemHandle, pvRangeAddrStart, ui32Length,
							   __ambcache_clean_range, outer_clean_range);
}
...
{
	return CheckExecuteCacheOp(hOSMemHandle, pvRangeAddrStart, ui32Length,
							   __ambcache_inv_range, outer_inv_range);
}
