...
#endif
static SGX_INLINE IMG_VOID SysAcquireData(SYS_DATA **ppsSysData)
{
...
#endif
static SGX_INLINE SYS_DATA * SysAcquireDataNoCheck(IMG_VOID)
{
...
#endif
static SGX_INLINE PVRSRV_ERROR SysInitialiseCommon(SYS_DATA *psSysData)
{
	PVRSRV_ERROR	eError;
...
#endif
static SGX_INLINE IMG_VOID SysDeinitialiseCommon(SYS_DATA *psSysData)
{
...
#endif
static SGX_INLINE IMG_HANDLE SysHighResTimerCreate(IMG_VOID)
{
	SYS_DATA *psSysData;
...
#endif
static SGX_INLINE IMG_UINT32 SysHighResTimerGetus(IMG_HANDLE hTimer)
{
	SYS_DATA *psSysData;
...
#endif
static SGX_INLINE IMG_VOID SysHighResTimerDestroy(IMG_HANDLE hTimer)
{
	SYS_DATA *psSysData;
