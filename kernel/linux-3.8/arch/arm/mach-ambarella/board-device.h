...
extern int ambarella_init_fm34(u8 i2c_bus_num, u8 rst_pin, u8 rst_delay, u8 pd_pin, u8 spk_mute_pin);
extern int ambarella_init_ak4954(u8 i2c_bus_num, u8 i2c_addr, u8 rst_pin);
