...
{
	return clk_get_rate(clk_get(NULL, "gclk_cortex"));
}
EXPORT_SYMBOL(get_cortex_freq_hz);
#endif

u32 get_core_bus_freq_hz(void)
{
	return clk_get_rate(clk_get(NULL, "gclk_core"));
}
EXPORT_SYMBOL(get_core_bus_freq_hz);

u32 get_ahb_bus_freq_hz(void)
{
	return clk_get_rate(clk_get(NULL, "gclk_ahb"));
}
...
{
	return clk_get_rate(clk_get(NULL, "pll_out_ddr")) / 2;
}
EXPORT_SYMBOL(get_dram_freq_hz);

u32 get_idsp_freq_hz(void)
{
	return clk_get_rate(clk_get(NULL, "pll_out_idsp"));
}
