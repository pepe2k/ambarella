			      ...
			      u16 maxact_scan_per_ssid)
{
	...
	if (minact_chdw_msec == 0) minact_chdw_msec = 30;
	if (maxact_chdw_msec == 0) maxact_chdw_msec = 110;
	if (pas_chdw_msec == 0) pas_chdw_msec = 110;
	if (maxact_scan_per_ssid == 0) maxact_scan_per_ssid = 2;
