...
#define SYS_CONFIG_SPI_EEPROM_ADDR	0x00000010 /* bit4 - 0:2 bytes ,1: 3 bytes ,For BOOT ROM Mode */
#define SYS_CONFIG_NAND_READ_CONFIRM	0x00000020 /* 0: does not use, 1: use */
...
#define SYS_CONFIG_EMMC_SD_HS		0x00010000 /* 0:  Normal speed(25Mhz), 1: High speed(up to 50Mhz) */
#define SYS_CONFIG_EMMC_SD_DDR		0x00020000 /* 0:  Single SDR mode, 1: Double DDR mode */
#define SYS_CONFIG_EMMC_SD_4BIT		0x00040000 /* eMMC 4 bit Bus Width - 0:  disable, 1: enable */
#define SYS_CONFIG_EMMC_SD_8BIT		0x00080000 /* eMMC 8 bit Bus Width - 0:  disable, 1: enable */
...
#define SYS_CONFIG_VSYNC_CLK_SRC	0x20000000 /* 0: Normal source, 1: Reference Clock */
#define SYS_CONFIG_HSYNC_CLK_SRC	0x40000000 /* 0: Normal source, 1: Reference Clock */
#define SYS_CONFIG_SET_EFUSE_ROM	0x80000000 /* 0: set on pins, 1: set on eFUSE ROM (expect POC[8,12]) */
